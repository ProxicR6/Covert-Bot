...
async def on_ready():
    ...
    embed.add_field(name=1, value="Do not give this discord out to none eSports teams", inline=False)
    embed.add_field(name=2, value="Any toxicity will result in ban", inline=False)
    embed.add_field(name=3, value="Use the correct chats", inline=False)
    embed.add_field(name=4, value="If you have any questions please contact one of the owners", inline=False)
